...
<head>
    <meta charset="UTF-8">
    <title>Portail Admin - UpcycleConnect</title>
...
<body class="bg-gray-900 min-h-screen flex items-center justify-center">
    <div class="bg-white rounded-2xl shadow-xl p-10 w-full max-w-sm">
        ...
        <?php endif; ?>
        <form method="POST" action="/UpcycleConnect-PA2526/frontend/public/maintenance-login" class="space-y-4">
            <div>
        ...
        <div class="text-center mt-6">
            <a href="/UpcycleConnect-PA2526/frontend/public/" class="text-xs text-gray-400 hover:text-gray-600">← Retour</a>
        </div>
    </div>
</body>
</html>
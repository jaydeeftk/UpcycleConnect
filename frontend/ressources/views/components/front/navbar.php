<header class="bg-base-100 shadow-sm sticky top-0 z-50">
    ...
    <a href="/UpcycleConnect-PA2526/frontend/public/admin/dashboard"
       class="flex items-center gap-2 text-sm font-medium bg-gray-900 text-white px-4 py-2 rounded-xl hover:bg-gray-700 transition"
...
<?php else: ?>
    <a href="/UpcycleConnect-PA2526/frontend/public/admin-portal-access"
       class="text-base-content/30 hover:text-base-content/50 transition" title="Accès restreint">

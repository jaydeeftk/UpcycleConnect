        ...
        <form method="POST" action="/conteneurs/store">
            ...
            <div class="mb-8">
                ...
                <div class="space-y-5">
                    ...
                    <div>
                        <label class="block text-sm font-medium mb-2">Photo de l'objet</label>
                        <input
                            type="url"
                            name="photo_url"
                            placeholder="https://... (lien vers une photo de votre objet)"
                            class="input input-bordered w-full"
                            value="<?= htmlspecialchars($_POST['photo_url'] ?? '') ?>"
                        >
                        <p class="text-xs text-base-content/50 mt-1">Facultatif — ajoutez un lien vers une photo pour faciliter la validation.</p>
                    </div>

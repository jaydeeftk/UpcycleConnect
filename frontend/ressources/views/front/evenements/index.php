<section class="max-w-7xl mx-auto px-6 lg:px-10 py-16">
    <div class="mb-12">
        ...
        <p class="text-lg text-base-content/70 max-w-2xl">
            <?= t('evtidx_subtitle', 'Découvrez les ateliers, rencontres et événements organisés autour de la réparation, de la transformation et du recyclage.') ?>
        </p>
    </div>
    ...
    <div class="grid md:grid-cols-3 gap-8">
                ...
                <div class="bg-base-100 rounded-2xl shadow-sm overflow-hidden">
                    ...
                    <div class="p-6">
                        ...
                        <a href="/evenements/<?= $evenement['id'] ?>"
                            ...
                            <?= t('evtidx_view_event', "Voir l'événement") ?> →
                        </a>
                    </div>
                </div>
            <?php endforeach; ?>
        <?php else: ?>
            <div class="col-span-3 text-center text-base-content/60 py-12">
                <?= t('evtidx_empty', 'Aucun événement disponible pour le moment.') ?>
            </div>
        <?php endif; ?>
...
<section class="bg-base-100 border-t border-base-300">
    <div class="max-w-7xl mx-auto px-6 lg:px-10 py-16 text-center">
        <h2 class="text-3xl font-bold mb-4"><?= t('evtidx_cta_title', 'Participez à la communauté UpcycleConnect') ?></h2>
        <p class="text-base-content/70 max-w-2xl mx-auto mb-6">
            <?= t('evtidx_cta_text', 'Rejoignez des événements près de chez vous pour apprendre, rencontrer des prestataires et découvrir de nouvelles façons de donner une seconde vie à vos objets.') ?>
        </p>
        <a href="/login"
            class="inline-block bg-black text-white px-8 py-3 rounded-xl font-medium hover:bg-neutral-800 transition">
            <?= t('evtidx_cta_btn', "S'inscrire à un événement") ?>
        </a>
    </div>
</section>